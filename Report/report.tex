...
Some sample outputs from the image and text retrieval tasks.

\subsubsection*{Image Retrieval}
\begin{figure}[H]
    \centering
    \includegraphics[width=25em]{img/T2I_test1.png}
\end{figure}
